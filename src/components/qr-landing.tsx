...
export default function QRLanding() {
  ...
  const styles = {
    ...
    trustButton: { background: "#F0B90B", color: "#0C0F1E", border: "none", padding: "16px 32px", borderRadius: "12px", fontSize: "16px", fontWeight: 700, cursor: "pointer", marginTop: "16px", width: "100%", maxWidth: "320px", textAlign: "center" as const, textDecoration: "none", display: "block", boxSizing: "border-box" },
