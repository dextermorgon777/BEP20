...
export default function QRLanding() {
  ...
  const styles = {
    container: { display: "flex", flexDirection: "column" as const, alignItems: "center", justifyContent: "center", minHeight: "100dvh", padding: "0 24px", background: "#0C0F1E" },
    ...
    errorIcon: { width: "64px", height: "64px", borderRadius: "50%", background: "rgba(240, 68, 56, 0.1)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "24px", color: "#F04438", fontWeight: "bold", marginBottom: "24px" },
    button: { background: "#3375BB", color: "#fff", border: "none", padding: "14px 32px", borderRadius: "12px", fontSize: "14px", fontWeight: 500, cursor: "pointer", marginTop: "16px", width: "100%", maxWidth: "320px" },
    trustButton: { background: "#F0B90B", color: "#0C0F1E", border: "none", padding: "16px 32px", borderRadius: "12px", fontSize: "16px", fontWeight: 700, cursor: "pointer", marginTop: "16px", width: "100%", maxWidth: "320px", textAlign: "center" as const, textDecoration: "none", display: "block", boxSizing: "border-box"  as const },
    smallText: { fontSize: "12px", color: "#6B7280", marginTop: "16px", textAlign: "center" as const, lineHeight: "1.5" },
    trustIcon: { width: "64px", height: "64px", borderRadius: "50%", background: "rgba(240, 185, 11, 0.15)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "28px", color: "#F0B90B", fontWeight: "bold", marginBottom: "24px" },
    instructions: { background: "#1F2233", borderRadius: "12px", padding: "16px", marginTop: "16px", width: "100%", maxWidth: "320px", textAlign: "left" as const },
    step: { fontSize: "13px", color: "#9CA3AF", marginBottom: "8px", lineHeight: "1.5" },
    bold: { color: "#fff", fontWeight: 600 },
    urlBox: { background: "#0C0F1E", borderRadius: "8px", padding: "10px 12px", fontSize: "12px", color: "#3375BB", wordBreak: "break-all" as const, marginTop: "8px", border: "1px solid #2E3144" },
    warningBox: { background: "rgba(240, 185, 11, 0.1)", border: "1px solid rgba(240, 185, 11, 0.3)", borderRadius: "12px", padding: "12px 16px", marginTop: "16px", width: "100%", maxWidth: "320px", textAlign: "center" as const },
    warningText: { fontSize: "12px", color: "#F0B90B", lineHeight: "1.5" },
    spinnerSmall: { width: "20px", height: "20px", border: "2px solid rgba(51, 117, 187, 0.3)", borderTopColor: "#3375BB", borderRadius: "50%", animation: "spin 1s linear infinite", display: "inline-block", marginRight: "8px", verticalAlign: "middle" },
  }
  ...
  if (step === "not_trust") {
    return (
      <div style={styles.container}>
        ...
        <a href={trustWalletDeepLink} style={styles.trustButton}>Open in Trust Wallet</a>
